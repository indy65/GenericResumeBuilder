...
<link rel="icon" type="image/png" sizes="96x96" href="/favicon-32.png"/>
...
function adSlot(size = 'leaderboard') {
  // ADS DISABLED — uncomment and fill in publisher/slot IDs when ready
  return '';
  /*
  if (size === 'leaderboard') {
